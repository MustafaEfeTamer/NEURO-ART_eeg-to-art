...
def main():
    ...
    r.record_title = 'TUNAHANd' # required param and can not be empty
    r.record_description = 'TUNAHANd' # optional param
    ...
    record_duration_s = 600 # duration for recording in this example. It is not input param of create_record
